...
| `H0010` | error | comparison chaining is not supported | One comparison is used directly as an operand of another comparison. Repeat the middle operand and join independent comparisons instead. |
