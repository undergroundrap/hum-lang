...
| [0017](0017-adopt-structural-app-authority-boundary.md) | proposed | Make the executable app structural, source authority bounded, operator consent explicit, and native paths non-Text. |
