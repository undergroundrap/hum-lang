...
first statement candidates, expression preview atoms, operators, and blockers
...
Core Hum candidate operation families, expression preview atoms, operators, and
...
- `hum core-preview` is a candidate, expression preview, and blocker report, not
  executable Core Hum.
