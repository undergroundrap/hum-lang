...
- It must stay in sync with `hum core-lower --format json`,
  `hum core-verify --format json`, `hum effect-check --format json`, `hum ownership-check --format json`, `hum resource-check --format json`, `hum ir-contract --format json`, `hum ir-readiness --format json`,
