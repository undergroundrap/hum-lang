...
pub const HUM_MILESTONE: &str = "two canonical source-driven native program features";
...
mod tests {
    ...
    fn text_version_reports_hum_version_and_schemas() {
        ...
        assert!(text.contains("core_verify_schema: hum.core_verify.v0"));
        ...
        assert!(text.contains("full_type_check_schema: hum.full_type_check.v0"));
        assert!(text.contains("effect_check_schema: hum.effect_check.v0"));
        assert!(text.contains("ownership_check_schema: hum.ownership_check.v0"));
        assert!(text.contains("resource_check_schema: hum.resource_check.v0"));
        assert!(text.contains("profile_check_schema: hum.profile_check.v0"));
        ...
        assert!(text.contains("backend_input_schema: hum.backend_input.v0"));
    ...
    fn json_version_reports_machine_readable_identity() {
        ...
        assert!(json.contains("\"full_type_check\": \"hum.full_type_check.v0\""));
