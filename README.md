...
- `hum graph <file-or-dir>...`: emit `hum.semantic_graph.v0` JSON for tools and agents, including source-derived node IDs, section line facts, task test obligations, and exact or conservative canonical `covers:` links
