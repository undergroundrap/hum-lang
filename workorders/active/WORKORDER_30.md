...
PR B (Item 2) takes `H0641` → allocation 97 / cause 191 / ordinal 97.
PR C (Item 3, `H0642`) allocates from the next free position after
PR B lands; the `H06xx` spellings are unaffected.
