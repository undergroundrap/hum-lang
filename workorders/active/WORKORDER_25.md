...
| `crates/hum-dev/src/shell.rs` | 280 | 0 | process launch, environment, and stream ownership |
...
| **Unit C total** | **1,200** | **1,120** | **13 non-borrowable paths** |

| Unit C category | Paths | Max + | Max - |
| --- | ---: | ---: | ---: |
| `hum-dev` Rust and tests | 5 | 640 | 80 |
| PowerShell wrappers/tests | 5 | 380 | 900 |
| Workflow | 1 | 60 | 80 |
| Documentation | 2 | 120 | 60 |
| **Unit C category total** | **13** | **1,200** | **1,120** |
