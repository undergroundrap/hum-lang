...
'@
  ...
  if ([regex]::IsMatch($Wo18CompileFailure.Output, 'error\[E0382\]|error\[E(?:0412|0422|0432|0433|0603)\]|unexpected `cfg`|unresolved import|cannot find (?:type|struct|module)|expected item, found')) { throw 'Work Order 18 backend facts proof failed for an unrelated move, symbol, cfg, import, privacy-type, or syntax reason' }
