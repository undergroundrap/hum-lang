...
if (Test-TextFile $ExcludedInvalidFixture) { throw 'Invalid Cargo cache fixture entered the readiness scan' }
if (-not (Test-TextFile $IncludedInvalidFixture)) { throw 'Invalid Cargo cache lookalike escaped the readiness scan' }
